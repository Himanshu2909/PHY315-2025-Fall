...
1. Thermometry
	...
	2. Sensors: Platinum Resistance (saturates <10K), Semiconductors (good at low T), Thermocouples
	3. Cernox Thermometers
2. Cooling Techniques
	1. Liquid Cryogens
	2. Pumping on Cryogens
	3. Magnetocaloric Effect (Adiabatic Demagnetization): Cycle of Isothermal Magnetization & Adiabatic Demagnetization
	4. Entropy Formula
	5. Resistivity & Magnetism
		1. Resistivity-Temperature Relations
		2. Rare Earth Metals
	6. Superconductivity
		1. Critical Temperature
		2. Specific Heat and discontinuous jump at Critial Temperature
		3. Magnetic Susceptibility, Meissner effect
		4. Resistivity Trends: Phonon scattering, Magnetic border (Magnons), Kondo Effect
		5. Pressure Dependence
			1. Impact of high pressure on critial temperature
...
5. Optics & Ultrafast Optics
	...
	4. Pump-Probe Spectroscopy
		1. Beam splitting
		2. Optical Delay lines
		3. Chemical bond breaking
		4. Ionic-Covalent Resonance
...
- [ ] e/m by Bar Magnet Experiment
- [ ] Optical Spectroscopy & Quantum Dots Experiment
- [ ] Peltier Heat Pump Experiment
- [ ] Thin Film Deposition and Characterization
- [ ] Cavendish Experiment
- [ ] Thermoelectric Power Experiment
